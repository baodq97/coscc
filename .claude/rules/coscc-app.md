...
- **A session reads nothing of `~/.claude/`, and of the project only what the app hands it.**
  ...
  the session through `coscc/instructions.py`, in the system prompt; a rule **with** `paths:`
