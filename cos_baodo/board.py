...
from a URL somebody typed (`0002`), so `<workspace>/.claude/scripts/cos.mjs` is a file that
...
# The app's own copy. `cos_baodo/` sits beside `.claude/` in the flat layout `0002` chose
